...
//                    break;
//                }
//                case BC_POP: throw InterpretationError("BC_POP instruction not implemented");
//                case BC_LOADDVAR0: pushVariable(loadVariable(0));
//                    break;
//                case BC_LOADDVAR1: pushVariable(loadVariable(1));
//                    break;
//                case BC_LOADDVAR2: pushVariable(loadVariable(2));
//                    break;
//                case BC_LOADDVAR3: pushVariable(loadVariable(3));
//                    break;
//                case BC_LOADIVAR0: pushVariable(loadVariable(0));
//                    break;
//                case BC_LOADIVAR1: pushVariable(loadVariable(1));
//                    break;
//                case BC_LOADIVAR2: pushVariable(loadVariable(2));
//                    break;
//                case BC_LOADIVAR3: pushVariable(loadVariable(3));
//                    break;
//                case BC_LOADSVAR0: pushVariable(loadVariable(0));
//                    break;
//                case BC_LOADSVAR1: pushVariable(loadVariable(1));
//                    break;
//                case BC_LOADSVAR2: pushVariable(loadVariable(2));
//                    break;
//                case BC_LOADSVAR3: pushVariable(loadVariable(3));
//                    break;
//                case BC_STOREDVAR0: storeVariable(0);
//                    break;
//                case BC_STOREDVAR1: storeVariable(1);
//                    break;
//                case BC_STOREDVAR2: storeVariable(2);
//                    break;
//                case BC_STOREDVAR3: storeVariable(3);
//                    break;
//                case BC_STOREIVAR0: storeVariable(0);
//                    break;
//                case BC_STOREIVAR1: storeVariable(1);
//                    break;
//                case BC_STOREIVAR2: storeVariable(2);
//                    break;
//                case BC_STOREIVAR3: storeVariable(3);
//                    break;
...
//                    break;
//                case BC_STORESVAR3: storeVariable(0);
//                    break;
//                case BC_LOADDVAR: pushVariable(loadVariable(bytecode.getUInt16(currentIndex + 1)));
//                    break;
//                case BC_LOADIVAR: pushVariable(loadVariable(bytecode.getUInt16(currentIndex + 1)));
//                    break;
//                case BC_LOADSVAR: pushVariable(loadVariable(bytecode.getUInt16(currentIndex + 1)));
//                    break;
//                case BC_STOREDVAR: storeVariable(bytecode.getUInt16(currentIndex + 1));
//                    break;
//                case BC_STOREIVAR: storeVariable(bytecode.getUInt16(currentIndex + 1));
//                    break;
//                case BC_STORESVAR: storeVariable(bytecode.getUInt16(currentIndex + 1));
//                    break;
//                case BC_LOADCTXDVAR: pushVariable(loadVariable(bytecode.getUInt16(currentIndex + 1), bytecode.getUInt16(currentIndex + 3)));
//                    break;
//                case BC_LOADCTXIVAR: pushVariable(loadVariable(bytecode.getUInt16(currentIndex + 1), bytecode.getUInt16(currentIndex + 3)));
//                    break;
//                case BC_LOADCTXSVAR: pushVariable(loadVariable(bytecode.getUInt16(currentIndex + 1), bytecode.getUInt16(currentIndex + 3)));
//                    break;
//                case BC_STORECTXDVAR: storeVariable(bytecode.getUInt16(currentIndex + 1), bytecode.getUInt16(currentIndex + 3));
//                    break;
//                case BC_STORECTXIVAR: storeVariable(bytecode.getUInt16(currentIndex + 1), bytecode.getUInt16(currentIndex + 3));
//                    break;
...
//                    continue;
//                }
//                case BC_DUMP: throw InterpretationError("BC_DUMP instruction not implemented");
//                case BC_STOP: {
//                    indices.clear();
//                    bytecodes.clear();
//                    continue;
...
//                    continue;
//                }
//                case BC_CALLNATIVE: callNative(bytecode.getUInt16(currentIndex + 1));
//                    break;
//                case BC_RETURN: {
//                    indices.pop_back();
//                    bytecodes.pop_back();
...
//                    continue;
//                }
//                case BC_BREAK: throw InterpretationError("BC_BREAK instruction not implemented");
//                case BC_LAST: throw InterpretationError("BC_LAST instruction is invalid");
//            }
