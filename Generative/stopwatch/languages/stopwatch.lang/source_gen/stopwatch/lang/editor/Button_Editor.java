...
public class Button_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_78mff1_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_78mff1_f0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_78mff1_g0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_78mff1_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Actions order");
  ...
  private EditorCell createRefNodeList_78mff1_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Button_Editor.actionsListHandler_78mff1_f0(node, "actions", editorContext);
  ...
  private static class actionsListHandler_78mff1_f0 extends RefNodeListHandler {
    public actionsListHandler_78mff1_f0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_78mff1_g0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "}");
    editorCell.setCellId("Constant_78mff1_g0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.MATCHING_LABEL, "body-brace");
