...
public class Language extends LanguageRuntime {
  ...
  public SLanguageId getId() {
    return new SLanguageId(UUID.fromString("a2c55519-5234-4e83-b8f8-06b09652be8e"));
  }
  @Override
  ...
  public Collection<TemplateModule> getGenerators() {
    return TemplateUtil.<TemplateModule>asCollection(TemplateUtil.createInterpretedGenerator(this, "a782e5ae-ef2a-4f6f-93a1-600fb244e034(Schedule#2730820940293113472)"));
  }
  @Override
  protected <T extends LanguageAspectDescriptor> T createAspectDescriptor(Class<T> descriptorClass) {
    if (descriptorClass == ConstraintsAspectDescriptor.class) {
      return (T) new Schedule.constraints.ConstraintsAspectDescriptor();
    }
